...
#plt.show()
file1 = open('D:\dissertation\dataset\citation-network1\outputacm.txt', "r",encoding='utf-8')
count = 0
...
file = open('D:\dissertation\dataset\citation-network1\outputacm.csv', 'a+', encoding='utf-8', newline='')

# writing the data into the file
with file:
        write = csv.writer(file)
        write.writerows(final)
#df.to_csv('D:\dissertation\dataset\citation-network1\outputacm.csv', mode='a')