...
df=pd.read_csv(r"C:\Users\Vidhi Bansal\Downloads\acm_datasetFinalUsed.csv", encoding="utf8")
...
#df.to_csv(r"C:\Users\Vidhi Bansal\Downloads\acm_datasetFinalUsed.csv",index=False)
...
for m in size:
      ...
      data = dict()
      print("accuracy with "+ i*100+"% test data")
      ...
      plt.xlabel("ML model")
     # plt.title("Accuracy with "+ str(m*100)+"% test data")
     # plt.savefig("Accuracy with "+ str(m*100)+"% test data.png")
